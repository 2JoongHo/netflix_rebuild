...
const requests = {
  ...
  tv: {
    fetchNetflixOriginals: `/discover/tv?api_key=${API_KEY}&with_networks=213&language=ko-KR`,
    fetchTrending: `/trending/all/week?api_key=${API_KEY}&language=ko-KR`, // 최신 시리즈
    fetchTopRated: `/tv/top_rated?api_key=${API_KEY}&language=ko-KR`, // 인기 시리즈
    fetchActionSeries: `/discover/tv?api_key=${API_KEY}&with_genres=10759&language=ko-KR`, // 액션 시리즈
    fetchAnimationSeries: `/discover/tv?api_key=${API_KEY}&with_genres=16&language=ko-KR`, // 애니메이션
    fetchComedySeries: `/discover/tv?api_key=${API_KEY}&with_genres=35&language=ko-KR`, // 코미디
    fetchDocumentarySeries: `/discover/tv?api_key=${API_KEY}&with_genres=99&language=ko-KR`, // 다큐멘터리
    fetchDramaSeries: `/discover/tv?api_key=${API_KEY}&with_genres=18&language=ko-KR`, // 드라마
    fetchKidSeries: `/discover/tv?api_key=${API_KEY}&with_genres=10762&language=ko-KR`, // 어린이 드라마
    fetchMysterySeries: `/discover/tv?api_key=${API_KEY}&with_genres=9648&language=ko-KR`, // 미스테리 시리즈
    fetchRealitySeries: `/discover/tv?api_key=${API_KEY}&with_genres=10764&language=ko-KR`, // 리얼리티쇼
    fetchFantasySeries: `/discover/tv?api_key=${API_KEY}&with_genres=10765&language=ko-KR`, // 판타지 시리즈
    fetchTalkSeries: `/discover/tv?api_key=${API_KEY}&with_genres=10767&language=ko-KR`, // 토크쇼
  },
};
